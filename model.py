...
from tensorflow.keras.layers import Conv2D, MaxPooling2D, LeakyReLU, Dropout, GlobalMaxPooling2D, Flatten, Lambda, Dense
...
def build_network(img_size=256, out_dim=128):
    ...
    model = tf.keras.Model(inputs=[{'anchor': anchor_in,
                                    'pos_img': pos_in,
...
# noinspection PyPep8
def o_build_network(img_size=256, out_dim=128):
    in_dims = [img_size, img_size, 3]
